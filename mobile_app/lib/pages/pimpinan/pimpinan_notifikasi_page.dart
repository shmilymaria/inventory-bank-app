...
class PimpinanNotifikasiPage extends StatefulWidget {
  const PimpinanNotifikasiPage({super.key});
  @override
  State<PimpinanNotifikasiPage> createState() =>
      _PimpinanNotifikasiPageState();
}

class _PimpinanNotifikasiPageState extends State<PimpinanNotifikasiPage> {
  List<dynamic> _data    = [];
  bool          _loading = true;
