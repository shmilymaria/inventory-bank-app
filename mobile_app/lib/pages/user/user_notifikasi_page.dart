...
class UserNotifikasiPage extends StatefulWidget {
  const UserNotifikasiPage({super.key});
  @override
  State<UserNotifikasiPage> createState() => _UserNotifikasiPageState();
}

class _UserNotifikasiPageState extends State<UserNotifikasiPage> {
  List<dynamic> _data    = [];
  bool          _loading = true;
  ...
  Widget build(BuildContext context) {
    ...
    final belumBaca  = _data.where(
        (n) => n['status_baca'] == 'Belum Dibaca').length;

    return Scaffold(
      appBar: AppBar(
        title          : Text('Notifikasi${belumBaca > 0 ? ' ($belumBaca)' : ''}'),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Icon(
                                    ...
                                    color: dibaca ? Colors.grey : primary,
                                    size : 22,
                                  ),
                                ),
