...
<div class="col-lg-9">
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            ...
            {{-- Info barang yang sedang diedit --}}
            <div class="alert py-2 mb-4" style="background:#f0f4ff;border:1px solid #c7d7fc;">
                <small class="text-primary">
                    <i class="bi bi-pencil me-1"></i>
                    Mengedit: <strong>{{ $barang->nama_barang }}</strong>
                    — Kode: <code>{{ $barang->kode_barang }}</code>
                </small>
            </div>
            ...
            <form method="POST" action="{{ route('barang.update', $barang->id) }}">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        @error('stok')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Stok saat ini: <strong>{{ $barang->stok }}</strong></div>
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Stok Minimum <span class="text-danger">*</span></label>
                        <input type="number" name="stok_minimum" id="inputStokMin"
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="satuan"
                            ...
                            @foreach(['Unit','Buah','Rim','Kotak','Lusin','Set','Pak','Lembar','Botol','Liter'] as $sat)
                                <option value="{{ $sat }}"
                                    {{ old('satuan', $barang->satuan) == $sat ? 'selected' : '' }}>
                                    {{ $sat }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    ...
                    <a href="{{ route('barang.show', $barang->id) }}" class="btn btn-outline-info px-4 ms-auto">
